...
"[project]/src/app/api/farms/[farmId]/monitoring/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const triggerSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    ...
    message: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$v3$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].string().min(3),
...
async function GET(request, context) {
    try {
        ...
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$monitoring$2f$monitoring$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["monitoringService"].getDashboard(farmId);
        return Response.json({
            success: true,
            data
        });
...
async function POST(request, context) {
    try {
        ...
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$monitoring$2f$monitoring$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["monitoringService"].triggerAlert({
            farmId,
            userId,
            ...input
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__35b3cdc3._.js.map