...
function UpdatesPage() {
    ...
    const createMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "UpdatesPage.useMutation[createMutation]": ()=>apiCall(`/api/farms/${farmId}/daily-updates`, {
                    method: 'POST',
                    body: JSON.stringify({
...
_s(UpdatesPage, "9sm4qSo9Iu4tooA54OMx6t3sWjE=", false, function() {
    return [
...
//# sourceMappingURL=_73703bea._.js.map