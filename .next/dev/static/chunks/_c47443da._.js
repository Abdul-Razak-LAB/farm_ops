...
function PayrollPage() {
    ...
    const runsQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "PayrollPage.useQuery[runsQuery]": ()=>apiCall(`/api/farms/${farmId}/payroll/runs`)
        }["PayrollPage.useQuery[runsQuery]"],
    ...
    const createRunMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "PayrollPage.useMutation[createRunMutation]": ()=>apiCall(`/api/farms/${farmId}/payroll/runs`, {
                    method: 'POST',
                    body: JSON.stringify({
        ...
        }["PayrollPage.useMutation[createRunMutation]"],
        onSuccess: {
            "PayrollPage.useMutation[createRunMutation]": ()=>{
    ...
    const approveRunMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "PayrollPage.useMutation[approveRunMutation]": (runId)=>apiCall(`/api/farms/${farmId}/payroll/runs/${runId}/approve`, {
                    method: 'POST',
                    body: JSON.stringify({
                        idempotencyKey: crypto.randomUUID()
                    })
                })
        }["PayrollPage.useMutation[approveRunMutation]"],
        onSuccess: {
            "PayrollPage.useMutation[approveRunMutation]": ()=>{
                void runsQuery.refetch();
            }
    ...
    const payRunMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "PayrollPage.useMutation[payRunMutation]": (runId)=>apiCall(`/api/farms/${farmId}/payroll/runs/${runId}/pay`, {
                    method: 'POST',
                    body: JSON.stringify({
                        idempotencyKey: crypto.randomUUID(),
        ...
        }["PayrollPage.useMutation[payRunMutation]"],
        onSuccess: {
            "PayrollPage.useMutation[payRunMutation]": ()=>{
                void runsQuery.refetch();
            }
...
_s(PayrollPage, "2C+R5VCHXZFfA7w8Kt0DFBksx8A=", false, function() {
    return [
...
//# sourceMappingURL=_c47443da._.js.map