...
function ProcurementPage() {
    ...
    const ordersQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "ProcurementPage.useQuery[ordersQuery]": ()=>apiCall(`/api/farms/${farmId}/procurement/orders`)
        }["ProcurementPage.useQuery[ordersQuery]"],
    ...
    const requestPurchaseMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "ProcurementPage.useMutation[requestPurchaseMutation]": ()=>apiCall(`/api/farms/${farmId}/procurement/requests`, {
                    method: 'POST',
                    body: JSON.stringify({
        ...
        }["ProcurementPage.useMutation[requestPurchaseMutation]"],
        onSuccess: {
            "ProcurementPage.useMutation[requestPurchaseMutation]": ()=>{
                setRequestReason('');
                setRequestAmount(0);
    ...
    const createOrderMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "ProcurementPage.useMutation[createOrderMutation]": ()=>apiCall(`/api/farms/${farmId}/procurement/orders`, {
                    method: 'POST',
                    body: JSON.stringify({
                        vendorId,
                        idempotencyKey: crypto.randomUUID(),
        ...
        }["ProcurementPage.useMutation[createOrderMutation]"],
        onSuccess: {
            "ProcurementPage.useMutation[createOrderMutation]": ()=>{
                setItemDescription('');
                setItemQty(1);
    ...
    const confirmDeliveryMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "ProcurementPage.useMutation[confirmDeliveryMutation]": ()=>apiCall(`/api/farms/${farmId}/procurement/deliveries`, {
                    method: 'POST',
                    body: JSON.stringify({
                        poId: deliveryPoId,
                        idempotencyKey: crypto.randomUUID(),
        ...
        }["ProcurementPage.useMutation[confirmDeliveryMutation]"],
        onSuccess: {
            "ProcurementPage.useMutation[confirmDeliveryMutation]": ()=>{
                setDiscrepancyNote('');
                setDeliveryQty(1);
...
_s(ProcurementPage, "13IkjdPl8BUIJ4zx0/5IqI+xYpY=", false, function() {
    return [
...
//# sourceMappingURL=_fd36d613._.js.map