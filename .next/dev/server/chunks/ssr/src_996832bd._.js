module.exports = [
"[project]/src/lib/media-upload-client.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/(dashboard)/vendor/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$media$2d$upload$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/media-upload-client.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function VendorPage() {
    ...
    const [poId, setPoId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [evidenceUrl, setEvidenceUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [isUploadingEvidence, setIsUploadingEvidence] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    const ordersQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: ()=>apiCall(`/api/farms/${farmId}/vendor/orders`),
        enabled: Boolean(farmId)
    });
    const confirmMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMutation"])({
    ...
    const handleEvidenceUpload = async (file)=>{
        ...
        setUploadProgress(0);
        try {
            const fileUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$media$2d$upload$2d$client$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["uploadFileWithSignedEndpoint"])(`/api/farms/${farmId}/media/signed-upload`, file, setUploadProgress);
...
//# sourceMappingURL=src_996832bd._.js.map