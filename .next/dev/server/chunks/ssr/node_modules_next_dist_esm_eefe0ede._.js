...
function writeToBFCache(now, varyPath, rsc, prefetchRsc, head, prefetchHead) {
    const entry = {
        ...
        staleAt: now + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$router$2d$reducer$2f$reducers$2f$navigate$2d$reducer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DYNAMIC_STALETIME_MS"],
        version: currentBfCacheVersion
    };
    const isRevalidation = false;
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$segment$2d$cache$2f$cache$2d$map$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setInCacheMap"])(bfcacheMap, varyPath, entry, isRevalidation);
}
...
function readFromBFCache(varyPath) {
    const isRevalidation = false;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$segment$2d$cache$2f$cache$2d$map$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getFromCacheMap"])(// might be. Pass -1 instead of the actual current time to bypass
    // staleness checks.
    -1, currentBfCacheVersion, bfcacheMap, varyPath, isRevalidation);
}
function readFromBFCacheDuringRegularNavigation(now, varyPath) {
    const isRevalidation = false;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$segment$2d$cache$2f$cache$2d$map$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getFromCacheMap"])(now, currentBfCacheVersion, bfcacheMap, varyPath, isRevalidation);
}
}),
...
function discoverKnownRoute(now, pathname, pendingEntry, routeTree, metadataVaryPath, couldBeIntercepted, canonicalUrl, isPPREnabled, hasDynamicRewrite) {
    ...
    if (pendingEntry !== null) {
        ...
        discoverKnownRoutePart(knownRouteTreeRoot, tree, firstPart, remainingParts, fulfilledEntry, now, pathname, tree, metadataVaryPath, couldBeIntercepted, canonicalUrl, isPPREnabled, hasDynamicRewrite);
    ...
    return discoverKnownRoutePart(knownRouteTreeRoot, tree, firstPart, remainingParts, null, now, pathname, tree, metadataVaryPath, couldBeIntercepted, canonicalUrl, isPPREnabled, hasDynamicRewrite);
}
/**
 ...
 */ function discoverKnownRoutePart(parentKnownRoutePart, routeTree, urlPart, remainingParts, existingEntry, now, pathname, fullTree, metadataVaryPath, couldBeIntercepted, canonicalUrl, isPPREnabled, hasDynamicRewrite) {
    ...
    if (segmentAppearsInURL) {
        ...
        if (paramName === null && urlPart !== segment) {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$segment$2d$cache$2f$cache$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["writeRouteIntoCache"])(now, pathname, fullTree, metadataVaryPath, couldBeIntercepted, canonicalUrl, isPPREnabled);
        }
    ...
    if (slots !== null) {
        for(const parallelRouteKey in slots){
            ...
            const result = discoverKnownRoutePart(knownRoutePart, childRouteTree, nextUrlPart, nextRemainingParts, existingEntry, now, pathname, fullTree, metadataVaryPath, couldBeIntercepted, canonicalUrl, isPPREnabled, hasDynamicRewrite);
    ...
    if (existingEntry !== null) {
        ...
        entry = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$segment$2d$cache$2f$cache$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["writeRouteIntoCache"])(now, pathname, fullTree, metadataVaryPath, couldBeIntercepted, canonicalUrl, isPPREnabled);
    }
    if (hasDynamicRewrite) {
        ...
        cookieStore.addEventListener('change', (event)=>{
            ...
            for (const cookie of event.changed){
                if (cookie.name === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$app$2d$router$2d$headers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NEXT_INSTANT_TEST_COOKIE"]) {
                    if (lockState !== null) {
                        console.error('Navigation lock already acquired. Concurrent locks ' + 'are not allowed. Did you forget to release the ' + 'previous lock?');
                        return;
                    }
                    acquireLock();
                    return;
...
function isNavigationLocked() {
    if ("TURBOPACK compile-time truthy", 1) {
        return document.cookie.includes(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$app$2d$router$2d$headers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NEXT_INSTANT_TEST_COOKIE"] + '=');
    }
    //TURBOPACK unreachable
    ;
}
...
function attemptToFulfillDynamicSegmentFromBFCache(now, segment, tree) {
    ...
    const adjustedCurrentTime = now - __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$router$2d$reducer$2f$reducers$2f$navigate$2d$reducer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["STATIC_STALETIME_MS"] + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$router$2d$reducer$2f$reducers$2f$navigate$2d$reducer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DYNAMIC_STALETIME_MS"];
    const bfcacheEntry = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$segment$2d$cache$2f$bfcache$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["readFromBFCacheDuringRegularNavigation"])(adjustedCurrentTime, varyPath);
    if (bfcacheEntry !== null) {
        ...
        const requestedAt = bfcacheEntry.staleAt - __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$router$2d$reducer$2f$reducers$2f$navigate$2d$reducer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DYNAMIC_STALETIME_MS"];
        // Now add the stale time used by dynamic prefetches.
        const dynamicPrefetchStaleAt = requestedAt + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$router$2d$reducer$2f$reducers$2f$navigate$2d$reducer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["STATIC_STALETIME_MS"];
...
function fulfillRouteCacheEntry(now, entry, tree, metadataVaryPath, couldBeIntercepted, canonicalUrl, isPPREnabled) {
...
function writeRouteIntoCache(now, pathname, tree, metadataVaryPath, couldBeIntercepted, canonicalUrl, isPPREnabled) {
    const pendingEntry = createDetachedRouteCacheEntry();
    const fulfilledEntry = fulfillRouteCacheEntry(now, pendingEntry, tree, metadataVaryPath, couldBeIntercepted, canonicalUrl, isPPREnabled);
    ...
    const varyPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$segment$2d$cache$2f$vary$2d$path$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getRouteVaryPath"])(pathname, renderedSearch, null);
    const isRevalidation = false;
...
async function fetchSegmentPrefetchesUsingDynamicRequest(task, route, fetchStrategy, dynamicRequestTree, spawnedEntries) {
    ...
    try {
        ...
        if (fetchStrategy === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$segment$2d$cache$2f$types$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FetchStrategy"].PPRRuntime) {
        ...
        const prefetchStream = createPrefetchResponseStream(responseBody, closed.resolve, function onResponseSizeUpdate(totalBytesReceivedSoFar) {
        ...
        fulfilledEntries = writeDynamicRenderResponseIntoCache(now, task, fetchStrategy, response, serverData, isResponsePartial, headVaryParams, staleAt, route, spawnedEntries);
        // Return a promise that resolves when the network connection closes, so
        // the scheduler can track the number of concurrent network connections.
        return {
            value: null,
...
function writeDynamicTreeResponseIntoCache(now, task, fetchStrategy, response, serverData, entry, couldBeIntercepted, canonicalUrl, routeIsPPREnabled, headVaryParams, originalPathname) {
    const renderedSearch = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$route$2d$params$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getRenderedSearch"])(response);
    ...
    const fulfilledEntry = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$segment$2d$cache$2f$optimistic$2d$routes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["discoverKnownRoute"])(now, originalPathname, entry, routeTree, metadataVaryPath, couldBeIntercepted, canonicalUrl, routeIsPPREnabled, false // hasDynamicRewrite
    );
    ...
    writeDynamicRenderResponseIntoCache(now, task, fetchStrategy, response, serverData, isResponsePartial, headVaryParams, getStaleAtFromHeader(now, response), fulfilledEntry, null);
}
...
function writeDynamicRenderResponseIntoCache(now, task, fetchStrategy, response, serverData, isResponsePartial, headVaryParams, staleAt, route, spawnedEntries) {
    if ((response.headers.get(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$lib$2f$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NEXT_NAV_DEPLOYMENT_ID_HEADER"]) ?? serverData.b) !== (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$navigation$2d$build$2d$id$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getNavigationBuildId"])()) {
        // The server build does not match the client. Treat as a 404. During
        // an actual navigation, the router will trigger an MPA navigation.
    ...
    for (const flightData of flightDatas){
        ...
        if (seedData !== null) {
            ...
            writeSeedDataIntoCache(now, task, fetchStrategy, tree, staleAt, seedData, isResponsePartial, spawnedEntries);
        }
        const head = flightData.head;
        if (head !== null) {
            // For head entries, use the head-specific vary params passed as parameter.
            fulfillEntrySpawnedByRuntimePrefetch(now, fetchStrategy, head, flightData.isHeadPartial, staleAt, headVaryParams, route.metadata, spawnedEntries);
        }
    }
...
function writeSeedDataIntoCache(now, task, fetchStrategy, tree, staleAt, seedData, isResponsePartial, entriesOwnedByCurrentTask) {
    ...
    if (slots !== null) {
        ...
        for(const parallelRouteKey in slots){
            ...
            if (childSeedData !== null && childSeedData !== undefined) {
                writeSeedDataIntoCache(now, task, fetchStrategy, childTree, staleAt, childSeedData, isResponsePartial, entriesOwnedByCurrentTask);
            }
        }
    }
}
...
async function getStaleAt(now, serverData, response) {
...
;
;
function navigate(state, url, currentUrl, currentRenderedSearch, currentCacheNode, currentFlightRouterState, nextUrl, freshnessPolicy, shouldScroll, navigateType) {
    const now = Date.now();
    const href = url.href;
    ...
    if (route !== null && route.status === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$segment$2d$cache$2f$cache$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EntryStatus"].Fulfilled) {
        ...
        return navigateUsingPrefetchedRouteTree(now, state, url, currentUrl, currentRenderedSearch, nextUrl, currentCacheNode, currentFlightRouterState, freshnessPolicy, shouldScroll, navigateType, route);
    }
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        if (route === null || route.status !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$segment$2d$cache$2f$cache$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EntryStatus"].Rejected) {
            ...
            if (optimisticRoute !== null) {
                ...
                return navigateUsingPrefetchedRouteTree(now, state, url, currentUrl, currentRenderedSearch, nextUrl, currentCacheNode, currentFlightRouterState, freshnessPolicy, shouldScroll, navigateType, optimisticRoute);
            }
        }
    }
    ...
    return navigateToUnknownRoute(now, state, url, currentUrl, currentRenderedSearch, nextUrl, currentCacheNode, currentFlightRouterState, freshnessPolicy, shouldScroll, navigateType).catch(()=>{
        // If the navigation fails, return the current state
        return state;
    });
}
function navigateToKnownRoute(now, state, url, canonicalUrl, navigationSeed, currentUrl, currentRenderedSearch, currentCacheNode, currentFlightRouterState, freshnessPolicy, nextUrl, shouldScroll, navigateType, debugInfo, // prediction. Passed through so it can be marked as having a dynamic rewrite
...
routeCacheEntry) {
    ...
    if (task !== null) {
        if (freshnessPolicy !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$router$2d$reducer$2f$ppr$2d$navigations$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FreshnessPolicy"].Gesture) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$router$2d$reducer$2f$ppr$2d$navigations$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["spawnDynamicRequests"])(task, url, nextUrl, freshnessPolicy, accumulation, routeCacheEntry);
        }
        return completeSoftNavigation(state, url, nextUrl, task.route, task.node, navigationSeed.renderedSearch, canonicalUrl, navigateType, shouldScroll, accumulation.scrollableSegments, debugInfo);
    }
    // Could not perform a SPA navigation. Revert to a full-page (MPA) navigation.
    return completeHardNavigation(state, url, navigateType);
}
function navigateUsingPrefetchedRouteTree(now, state, url, currentUrl, currentRenderedSearch, nextUrl, currentCacheNode, currentFlightRouterState, freshnessPolicy, shouldScroll, navigateType, route) {
    ...
    return navigateToKnownRoute(now, state, url, canonicalUrl, prefetchSeed, currentUrl, currentRenderedSearch, currentCacheNode, currentFlightRouterState, freshnessPolicy, nextUrl, shouldScroll, navigateType, null, route);
}
...
async function navigateToUnknownRoute(now, state, url, currentUrl, currentRenderedSearch, nextUrl, currentCacheNode, currentFlightRouterState, freshnessPolicy, shouldScroll, navigateType) {
    ...
    if ("TURBOPACK compile-time truthy", 1) {
        const prefetchResult = await tryNavigateUsingTestingAPIPrefetch(state, url, currentUrl, currentRenderedSearch, nextUrl, currentCacheNode, currentFlightRouterState, freshnessPolicy, shouldScroll, navigateType);
    ...
    const { flightData, canonicalUrl, renderedSearch, couldBeIntercepted, prerendered, debugInfo } = result;
    ...
    if (metadataVaryPath !== null) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$segment$2d$cache$2f$optimistic$2d$routes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["discoverKnownRoute"])(now, url.pathname, null, navigationSeed.routeTree, metadataVaryPath, couldBeIntercepted, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$router$2d$reducer$2f$create$2d$href$2d$from$2d$url$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createHrefFromUrl"])(canonicalUrl), prerendered, false // hasDynamicRewrite - not a retry, rewrite detection happens during traversal
        );
    }
    return navigateToKnownRoute(now, state, url, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$router$2d$reducer$2f$create$2d$href$2d$from$2d$url$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createHrefFromUrl"])(canonicalUrl), navigationSeed, currentUrl, currentRenderedSearch, currentCacheNode, currentFlightRouterState, freshnessPolicy, nextUrl, shouldScroll, navigateType, debugInfo, // came directly from the server. If a mismatch occurs during dynamic data
...
function completeSoftNavigation(oldState, url, referringNextUrl, tree, cache, renderedSearch, canonicalUrl, navigateType, shouldScroll, scrollableSegments, collectedDebugInfo) {
    ...
    const segmentPathsToScrollTo = onlyHashChange || !shouldScroll ? [] : scrollableSegments !== null ? scrollableSegments : oldState.focusAndScrollRef.segmentPaths;
    const newState = {
        canonicalUrl,
        renderedSearch,
        pushRef: {
        ...
        focusAndScrollRef: {
            ...
            apply: shouldScroll ? segmentPathsToScrollTo !== null ? true : oldState.focusAndScrollRef.apply : oldState.focusAndScrollRef.apply,
            onlyHashChange,
            hashFragment: //
            ...
            shouldScroll && url.hash !== '' ? decodeURIComponent(url.hash.slice(1)) : oldState.focusAndScrollRef.hashFragment,
 ...
 */ async function tryNavigateUsingTestingAPIPrefetch(state, url, currentUrl, currentRenderedSearch, nextUrl, currentCacheNode, currentFlightRouterState, freshnessPolicy, shouldScroll, navigateType) {
    if ("TURBOPACK compile-time truthy", 1) {
...
function createInitialCacheNodeForHydration(navigatedAt, initialTree, seedData, seedHead) {
    ...
    const task = createCacheNodeOnNavigation(navigatedAt, initialTree, null, 1, seedData, seedHead, null, null, false, accumulation);
    return task;
}
...
function updateCacheNodeOnNavigation(navigatedAt, oldUrl, oldCacheNode, oldRouterState, newRouteTree, newMetadataVaryPath, freshness, didFindRootLayout, seedData, seedHead, isSamePageNavigation, parentSegmentPath, parentParallelRouteKey, parentNeedsDynamicRequest, oldRootRefreshState, parentRefreshState, accumulation) {
    ...
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$match$2d$segments$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["matchSegment"])(newSegment, oldSegment)) {
        ...
        return createCacheNodeOnNavigation(navigatedAt, newRouteTree, newMetadataVaryPath, freshness, seedData, seedHead, parentSegmentPath, parentParallelRouteKey, parentNeedsDynamicRequest, accumulation);
    }
    ...
    !(isLeafSegment && isSamePageNavigation)) {
        ...
        const result = createCacheNodeForSegment(navigatedAt, newRouteTree, seedRsc, newMetadataVaryPath, seedHead, freshness);
...
function createCacheNodeOnNavigation(navigatedAt, newRouteTree, newMetadataVaryPath, freshness, seedData, seedHead, parentSegmentPath, parentParallelRouteKey, parentNeedsDynamicRequest, accumulation) {
    ...
    if (newSlots !== null) {
        ...
        for(let parallelRouteKey in newSlots){
            ...
            const taskChild = createCacheNodeOnNavigation(navigatedAt, newRouteTreeChild, newMetadataVaryPath, freshness, seedDataChild ?? null, seedHead, segmentPath, parallelRouteKey, parentNeedsDynamicRequest || needsDynamicRequest, accumulation);
            taskChildren.set(parallelRouteKey, taskChild);
            newCacheNodeSlots[parallelRouteKey] = taskChild.node;
            const taskChildRoute = taskChild.route;
            patchedRouterStateChildren[parallelRouteKey] = taskChildRoute;
...
function reuseSharedCacheNode(dropPrefetchRsc, existingCacheNode) {
    ...
    return createCacheNode(existingCacheNode.rsc, dropPrefetchRsc ? null : existingCacheNode.prefetchRsc, existingCacheNode.head, dropPrefetchRsc ? null : existingCacheNode.prefetchHead);
}
function createCacheNodeForSegment(now, tree, seedRsc, metadataVaryPath, seedHead, freshness) {
        ...
        case 0:
            {
                ...
                if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$router$2d$reducer$2f$reducers$2f$navigate$2d$reducer$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["DYNAMIC_STALETIME_MS"] > 0) {
        ...
        case 1:
            {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$segment$2d$cache$2f$bfcache$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["writeToBFCache"])(now, tree.varyPath, rsc, prefetchRsc, head, prefetchHead);
                if (isPage && metadataVaryPath !== null) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$client$2f$components$2f$segment$2d$cache$2f$bfcache$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["writeHeadToBFCache"])(now, metadataVaryPath, head, prefetchHead);
                }
                return {
...
routeCacheEntry) {
    ...
    const voidPromise = finishNavigationTask(task, nextUrl, primaryRequestPromise, refreshRequestPromises, routeCacheEntry);
    // `finishNavigationTask` is responsible for error handling, so we can attach
    // noop callbacks to this promise.
    voidPromise.then(noop, noop);
}
async function finishNavigationTask(task, nextUrl, primaryRequestPromise, refreshRequestPromises, routeCacheEntry) {
        ...
        case 1:
            {
                ...
                dispatchRetryDueToTreeMismatch(isHardRetry, primaryRequestResult.url, nextUrl, primaryRequestResult.seed, task.route, routeCacheEntry);
                return;
            }
        case 2:
            {
...
function ScrollAndMaybeFocusHandler({ segmentPath, children }) {
...
function OuterLayoutRouter({ parallelRouterKey, error, errorStyles, errorScripts, templateStyles, templateScripts, template, notFound, forbidden, unauthorized, segmentViewBoundaries }) {
  ...
  */ let segmentBoundaryTriggerNode = null;
        ...
        let child = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxs"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$contexts$2f$app$2d$router$2d$context$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["TemplateContext"].Provider, {
            value: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxs"])(ScrollAndMaybeFocusHandler, {
                segmentPath: segmentPath,
                children: [
...
function createVaryingParams(accumulator, originalParamsObject) {
    ...
    if (workUnitStore) {
        switch(workUnitStore.type){
            ...
            case 'prerender-legacy':
                ...
                return createStaticPrerenderParams(underlyingParams, workStore, workUnitStore, varyParamsAccumulator);
            case 'validation-client':
                // TODO(instant-validation): in build, this depends on samples
            ...
            case 'request':
                if ("TURBOPACK compile-time truthy", 1) {
                    ...
                    const isRuntimePrefetchable = false;
                    return createRenderParamsInDev(underlyingParams, devFallbackParams, workStore, workUnitStore, isRuntimePrefetchable);
                } else //TURBOPACK unreachable
                ;
            default:
                workUnitStore;
...
function createServerParamsForMetadata(underlyingParams, isRuntimePrefetchable) {
    const metadataVaryParamsAccumulator = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$app$2d$render$2f$vary$2d$params$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMetadataVaryParamsAccumulator"])();
    return createServerParamsForServerSegment(underlyingParams, metadataVaryParamsAccumulator, isRuntimePrefetchable);
}
            ...
            case 'prerender-runtime':
                {
                    ...
                    const isRuntimePrefetchable = false;
                    return createRuntimePrerenderParams(underlyingParams, workUnitStore, varyParamsAccumulator, isRuntimePrefetchable);
                }
            case 'request':
                if ("TURBOPACK compile-time truthy", 1) {
                    // Semantically we only need the dev tracking when running in `next dev`
...
function createServerParamsForServerSegment(underlyingParams, varyParamsAccumulator, isRuntimePrefetchable) {
    const workStore = __TURBOPACK__imported__module__$5b$externals$5d2f$next$2f$dist$2f$server$2f$app$2d$render$2f$work$2d$async$2d$storage$2e$external$2e$js__$5b$external$5d$__$28$next$2f$dist$2f$server$2f$app$2d$render$2f$work$2d$async$2d$storage$2e$external$2e$js$2c$__cjs$29$__["workAsyncStorage"].getStore();
    if (!workStore) {
        throw Object.defineProperty(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$shared$2f$lib$2f$invariant$2d$error$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["InvariantError"]('Expected workStore to be initialized'), "__NEXT_ERROR_CODE", {
            value: "E1068",
...
function createStaticPrerenderParams(underlyingParams, workStore, prerenderStore, varyParamsAccumulator) {
...
function createRuntimePrerenderParams(underlyingParams, workUnitStore, varyParamsAccumulator, isRuntimePrefetchable) {
    const underlyingParamsWithVarying = varyParamsAccumulator !== null ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$app$2d$render$2f$vary$2d$params$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createVaryingParams"])(varyParamsAccumulator, underlyingParams) : underlyingParams;
...
function createRenderParamsInDev(underlyingParams, devFallbackParams, workStore, requestStore, isRuntimePrefetchable) {
    ...
    return makeDynamicallyTrackedParamsWithDevWarnings(underlyingParams, hasFallbackParams, workStore, requestStore, isRuntimePrefetchable);
}
...
"[project]/node_modules/next/dist/esm/server/app-render/instant-validation/boundary.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
// at runtime even when production bundling/minification is used.
const NameSpace = {
    [__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$app$2d$render$2f$instant$2d$validation$2f$boundary$2d$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["INSTANT_VALIDATION_BOUNDARY_NAME"]]: function({ id, children }) {
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        // Track which boundaries we actually managed to render.
        const state = getValidationBoundaryTracking();
        if (state === null) {
            throw Object.defineProperty(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$shared$2f$lib$2f$invariant$2d$error$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["InvariantError"]('Missing boundary tracking state'), "__NEXT_ERROR_CODE", {
                value: "E1060",
                enumerable: false,
                configurable: true
            });
...
NameSpace[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$app$2d$render$2f$instant$2d$validation$2f$boundary$2d$constants$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["INSTANT_VALIDATION_BOUNDARY_NAME"].slice(0)];
}),
];

//# sourceMappingURL=node_modules_next_dist_esm_eefe0ede._.js.map