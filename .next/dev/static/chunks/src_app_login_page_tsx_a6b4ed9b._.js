...
function LoginPage() {
    ...
    const [email, setEmail] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(params.get('email') || '');
    ...
    const submit = async (event)=>{
        ...
        try {
            ...
            const result = contentType.includes('application/json') ? await response.json() : {
                success: false,
                error: {
                    message: 'Server returned a non-JSON response. Check /api/auth/login route.'
                }
            };
            if (!result.success) {
...
_s(LoginPage, "+f4rX9e9Dm3/wgJENYogQhaMEsc=", false, function() {
    return [
