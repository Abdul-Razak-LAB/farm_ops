...
"[project]/src/components/features/payroll/payroll-module.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PayrollModule() {
    ...
    const [workerId, setWorkerId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [grossAmount, setGrossAmount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [netAmount, setNetAmount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    ...
    const runsQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'payroll-runs',
            farmId
        ],
        queryFn: {
            "PayrollModule.useQuery[runsQuery]": ()=>apiCall(`/api/farms/${farmId}/payroll/runs`)
        }["PayrollModule.useQuery[runsQuery]"],
        enabled: Boolean(farmId)
    });
    const createRunMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "PayrollModule.useMutation[createRunMutation]": ()=>apiCall(`/api/farms/${farmId}/payroll/runs`, {
                    method: 'POST',
                    body: JSON.stringify({
        ...
        }["PayrollModule.useMutation[createRunMutation]"],
        onSuccess: {
            "PayrollModule.useMutation[createRunMutation]": ()=>{
    ...
    const approveRunMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "PayrollModule.useMutation[approveRunMutation]": (runId)=>apiCall(`/api/farms/${farmId}/payroll/runs/${runId}/approve`, {
                    method: 'POST',
                    body: JSON.stringify({
                        idempotencyKey: crypto.randomUUID()
                    })
                })
        }["PayrollModule.useMutation[approveRunMutation]"],
        onSuccess: {
            "PayrollModule.useMutation[approveRunMutation]": ()=>{
                void runsQuery.refetch();
            }
    ...
    const payRunMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "PayrollModule.useMutation[payRunMutation]": (runId)=>apiCall(`/api/farms/${farmId}/payroll/runs/${runId}/pay`, {
                    method: 'POST',
                    body: JSON.stringify({
                        idempotencyKey: crypto.randomUUID(),
        ...
        }["PayrollModule.useMutation[payRunMutation]"],
        onSuccess: {
            "PayrollModule.useMutation[payRunMutation]": ()=>{
                void runsQuery.refetch();
            }
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        ...
                        fileName: "[project]/src/components/features/payroll/payroll-module.tsx",
                        lineNumber: 89,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-xs text-muted-foreground uppercase font-semibold",
                        children: "Run prep, approvals, payment status"
                    }, void 0, false, {
                        fileName: "[project]/src/components/features/payroll/payroll-module.tsx",
                        lineNumber: 90,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: createRunMutation.isPending ? 'Creating...' : 'Create Run'
                    }, void 0, false, {
                        fileName: "[project]/src/components/features/payroll/payroll-module.tsx",
                        lineNumber: 131,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "space-y-3",
                        children: runsQuery.data?.length ? runsQuery.data.map((run)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: [
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(run.startDate),
                                            " - ",
                                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(run.endDate)
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/components/features/payroll/payroll-module.tsx",
                                        lineNumber: 159,
...
_s(PayrollModule, "2C+R5VCHXZFfA7w8Kt0DFBksx8A=", false, function() {
    return [
...
"[project]/src/app/(dashboard)/payroll/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$features$2f$payroll$2f$payroll$2d$module$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/features/payroll/payroll-module.tsx [app-client] (ecmascript)");
'use client';
;
;
function PayrollPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$features$2f$payroll$2f$payroll$2d$module$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PayrollModule"], {}, void 0, false, {
        fileName: "[project]/src/app/(dashboard)/payroll/page.tsx",
        lineNumber: 6,
        columnNumber: 10
    }, this);
}
...
//# sourceMappingURL=_3ae0a000._.js.map