...
"[project]/src/app/api/farms/[farmId]/weekly-digest/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, context) {
    try {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$permissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requirePermission"])(request, 'digest:read');
        const { farmId } = await context.params;
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$control$2f$control$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["controlService"].getWeeklyDigest(farmId);
        return Response.json({
            success: true,
            data
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2a249940._.js.map