...
"[project]/src/components/features/incidents/incidents-module.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function IncidentsModule() {
    ...
    const [severity, setSeverity] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('MEDIUM');
    const [issueEventId, setIssueEventId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [resolution, setResolution] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const timelineQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "IncidentsModule.useQuery[timelineQuery]": ()=>apiCall(`/api/farms/${farmId}/incidents`)
        }["IncidentsModule.useQuery[timelineQuery]"],
        enabled: Boolean(farmId)
    });
    const reportMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "IncidentsModule.useMutation[reportMutation]": ()=>apiCall(`/api/farms/${farmId}/incidents`, {
                    method: 'POST',
                    body: JSON.stringify({
                        title,
        ...
        }["IncidentsModule.useMutation[reportMutation]"],
        onSuccess: {
            "IncidentsModule.useMutation[reportMutation]": ()=>{
                setTitle('');
                setDetails('');
    ...
    const expertMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "IncidentsModule.useMutation[expertMutation]": ()=>apiCall(`/api/farms/${farmId}/incidents/expert-request`, {
                    method: 'POST',
                    body: JSON.stringify({
                        issueEventId,
                        idempotencyKey: crypto.randomUUID()
        ...
        }["IncidentsModule.useMutation[expertMutation]"],
        onSuccess: {
            "IncidentsModule.useMutation[expertMutation]": ()=>{
                void timelineQuery.refetch();
            }
    ...
    const resolveMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "IncidentsModule.useMutation[resolveMutation]": ()=>apiCall(`/api/farms/${farmId}/incidents/resolve`, {
                    method: 'POST',
                    body: JSON.stringify({
                        issueEventId,
                        resolution,
        ...
        }["IncidentsModule.useMutation[resolveMutation]"],
        onSuccess: {
            "IncidentsModule.useMutation[resolveMutation]": ()=>{
                setResolution('');
                void timelineQuery.refetch();
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        ...
                        fileName: "[project]/src/components/features/incidents/incidents-module.tsx",
                        lineNumber: 91,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-xs text-muted-foreground uppercase font-semibold",
                        children: "Escalation, expert support, resolution tracking"
                    }, void 0, false, {
                        fileName: "[project]/src/components/features/incidents/incidents-module.tsx",
                        lineNumber: 92,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: reportMutation.isPending ? 'Reporting...' : 'Report Incident'
                    }, void 0, false, {
                        fileName: "[project]/src/components/features/incidents/incidents-module.tsx",
                        lineNumber: 119,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "space-y-2",
                        children: timelineQuery.data?.length ? timelineQuery.data.map((event)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(event.createdAt)
                                            }, void 0, false, {
                                                fileName: "[project]/src/components/features/incidents/incidents-module.tsx",
                                                lineNumber: 167,
                                                columnNumber: 17
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: JSON.stringify(event.payload)
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/features/incidents/incidents-module.tsx",
                                        lineNumber: 169,
                                        columnNumber: 15
                            ...
                            children: "No incident events yet."
                        }, void 0, false, {
                            fileName: "[project]/src/components/features/incidents/incidents-module.tsx",
                            lineNumber: 171,
                            columnNumber: 16
...
_s(IncidentsModule, "eFx27e6KlnnNI+6VfdeFtri39tg=", false, function() {
    return [
...
_c = IncidentsModule;
var _c;
__turbopack_context__.k.register(_c, "IncidentsModule");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/app/(dashboard)/incidents/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$features$2f$incidents$2f$incidents$2d$module$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/features/incidents/incidents-module.tsx [app-client] (ecmascript)");
'use client';
;
;
function IncidentsPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$features$2f$incidents$2f$incidents$2d$module$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IncidentsModule"], {}, void 0, false, {
        fileName: "[project]/src/app/(dashboard)/incidents/page.tsx",
        lineNumber: 6,
        columnNumber: 10
    }, this);
}
...
//# sourceMappingURL=_1429f52c._.js.map