...
"[project]/src/lib/session-token.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function hashSessionToken(token) {
    return (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$crypto__$5b$external$5d$__$28$node$3a$crypto$2c$__cjs$29$__["createHash"])('sha256').update(`${token}:${process.env.APP_SECRET || ''}`).digest('hex');
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2d$token$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/session-token.ts [app-route] (ecmascript)");
;
;
;
...
async function POST(request) {
    try {
        ...
        const tokenPart = cookie.split(';').map((item)=>item.trim()).find((item)=>item.startsWith('session_token='));
        const rawToken = tokenPart?.split('=')[1];
        if (rawToken) {
            const tokenHash = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2d$token$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashSessionToken"])(decodeURIComponent(rawToken));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__33737c3d._.js.map