...
"[project]/src/hooks/outbox-transitions.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$outbox$2d$transitions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/outbox-transitions.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature(), _s1 = __turbopack_context__.k.signature();
;
;
;
            ...
            try {
                for (const item of pending){
                    try {
                        ...
                        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].outbox.update(item.id, (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$outbox$2d$transitions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toCompletedUpdate"])());
                    } catch (error) {
                        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].outbox.update(item.id, (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$outbox$2d$transitions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toFailedUpdate"])(item, error));
                    }
                }
                const count = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].outbox.where('status').equals('PENDING').count();
                setPendingCount(count);
...
"[project]/src/lib/observability.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "captureAppMessage",
    ()=>captureAppMessage,
    "reportIntegrationDegraded",
    ()=>reportIntegrationDegraded
]);
function getSentryGlobal() {
    if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
    ;
    const candidate = window.Sentry;
    return candidate ?? null;
}
function captureAppException(error, context) {
    const sentry = getSentryGlobal();
    sentry?.captureException?.(error, context);
    console.error(error);
}
function captureAppMessage(message, context) {
    const sentry = getSentryGlobal();
    sentry?.captureMessage?.(message, context);
    console.warn(message);
}
function reportIntegrationDegraded(integration, reason) {
        ...
        "Providers.useEffect": ()=>{
            const handleError = {
                "Providers.useEffect.handleError": (event)=>{
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$observability$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["captureAppException"])(event.error ?? new Error(event.message || 'Unhandled window error'), {
                        tags: {
                            scope: 'window.error'
                        }
                    });
            ...
            const handleRejection = {
                "Providers.useEffect.handleRejection": (event)=>{
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$observability$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["captureAppException"])(event.reason ?? new Error('Unhandled promise rejection'), {
                        tags: {
                            scope: 'window.unhandledrejection'
                        }
                    });
                }
            }["Providers.useEffect.handleRejection"];
...
_s(Providers, "kyo6Qet5MR/H3FjzUv8Py829tXg=", false, function() {
    return [
...
"[project]/src/components/layout/route-access.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/hooks/use-integration-status.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(useIntegrationStatus, "4ZpngI1uv+Uo3WQHEZmTQ5FNM+k=", false, function() {
    return [
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db/index.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$route$2d$access$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/layout/route-access.ts [app-client] (ecmascript)");
...
function NavigationShell({ children }) {
    ...
    const [quickAction, setQuickAction] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const controlsMenuRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])();
    const integrationStatus = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$integration$2d$status$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useIntegrationStatus"])();
    ...
    const handleQuickAction = async (action)=>{
        ...
        if (action === 'role:OWNER' || action === 'role:MANAGER' || action === 'role:WORKER') {
            const nextRole = action.replace('role:', '');
            setRole(nextRole);
            setControlsOpen(false);
            return;
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NavigationShell.useEffect": ()=>{
            ...
            const handlePointerDown = {
                "NavigationShell.useEffect.handlePointerDown": (event)=>{
                    const target = event.target;
                    if (!target) return;
                    if (controlsMenuRef.current?.contains(target)) return;
                    setControlsOpen(false);
                }
            }["NavigationShell.useEffect.handlePointerDown"];
            const handleKeyDown = {
                "NavigationShell.useEffect.handleKeyDown": (event)=>{
                    if (event.key === 'Escape') {
                        setControlsOpen(false);
                    }
                }
            }["NavigationShell.useEffect.handleKeyDown"];
    ...
    const hasRouteAccessForPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$route$2d$access$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["hasRouteAccess"])(pathname, role, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$route$2d$access$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ROUTE_RULES"]);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                        ...
                        children: filteredNav.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                href: item.href,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            controlsOpen ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "mt-1 w-[min(92vw,320px)] rounded-xl border bg-background/95 backdrop-blur p-3 space-y-3",
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "space-y-1",
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-[10px] uppercase text-muted-foreground font-semibold",
                                            children: "Select Control"
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/layout/navigation-shell.tsx",
                                            lineNumber: 224,
                                            columnNumber: 13
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                        ...
                        children: [
                            unavailableIntegrations.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            hasRouteAccessForPath ? children : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                                ...
                                children: filteredNav.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                                        className: "shrink-0",
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                            href: item.href,
...
_s(NavigationShell, "+MJ7FYDmWWaM6fR78SbY3CTphmE=", false, function() {
    return [
...
//# sourceMappingURL=src_f75df0e4._.js.map