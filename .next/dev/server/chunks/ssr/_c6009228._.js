...
"[project]/src/lib/observability.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/hooks/use-web-push.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$observability$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/observability.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function useWebPush() {
    ...
    const statusQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$integration$2d$status$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useIntegrationStatus"])();
    const isSupported = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>("TURBOPACK compile-time value", "undefined") !== 'undefined' && 'serviceWorker' in navigator && 'PushManager' in window, []);
    const integrationAvailable = statusQuery.data?.push ?? false;
    const subscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (farmId)=>{
        if (!isSupported) {
            setMessage('Push is unavailable on this browser. In-app alerts will be used.');
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$observability$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["reportIntegrationDegraded"])('push', 'PushManager unavailable in this browser');
            return;
        }
        if (!integrationAvailable) {
            setMessage('Push integration is currently unavailable. In-app alerts will be used.');
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$observability$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["reportIntegrationDegraded"])('push', 'Backend reported push unavailable');
            return;
        }
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$observability$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["reportIntegrationDegraded"])('push', error instanceof Error ? error.message : 'Push subscription failed');
...
"[project]/src/app/(dashboard)/updates/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$web$2d$push$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-web-push.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function UpdatesPage() {
    ...
    const { mutateAsync: queueDailyUpdate } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$offline$2d$sync$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useOfflineAction"])('updates', 'DAILY_UPDATE_SUBMITTED');
    const push = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$web$2d$push$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useWebPush"])();
    const [inputMode, setInputMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('VOICE');
    ...
    const [blockers, setBlockers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    const updatesQuery = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            'daily-updates',
            farmId
        ],
        queryFn: ()=>apiCall(`/api/farms/${farmId}/daily-updates`),
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: [
                    ...
                    inputMode === 'VOICE' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "space-y-2",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: updatesQuery.data?.length ? updatesQuery.data.map((entry)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    entry.payload?.blockers ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["formatDate"])(entry.createdAt)
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/(dashboard)/updates/page.tsx",
                                        lineNumber: 174,
                                        columnNumber: 15
...
//# sourceMappingURL=_c6009228._.js.map